public class CetakSiswa2 {
    ...
    public static void main(String[] args){
        ...
        data.no_absen = 1;// pemberian nilai pada variabel no_absen object class siswa deberi nilai 1
        System.out.println("No. Absen\t\t: "+data.no_absen);
        
        data.setNis("160001");//pemanggilan nama method object class siswa dengan nilai parameternya 160001
